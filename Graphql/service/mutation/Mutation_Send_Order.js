...
module.exports = async (name,surname,address,city,state,zip,order_name_quantity_price,totalprice,currency,img) => {


    let order_time = new Date()
    await sql.query( PizzaOrderInsert ,[name,surname,order_time,address,city,state,zip,totalprice,currency,img], function (err, result1) {
